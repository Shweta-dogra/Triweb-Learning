...
const getQuiz = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!quiz) {
            const err = new projectError_1.default("Quiz not found");
            err.statusCode = 404;
            throw err;
        }
        if (req.userId !== quiz.created_by.toString()) {
            const err = new projectError_1.default("You are not authorized to get Quiz");
            err.statusCode = 403;
            throw err;
        }
        const resp = { status: "success", message: "Quiz Get successfully", data: { quiz } };
...
const updateQuiz = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (quiz.is_published) {
            const err = new projectError_1.default("You Can not update pblished Quiz");
            err.statusCode = 405;
            throw err;
        }
...
const deleteQuiz = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (quiz.is_published) {
            const err = new projectError_1.default("You Can not Delete pblished Quiz");
            err.statusCode = 405;
            throw err;
        }
        yield quiz_1.default.deleteOne({ _id: quizId });
        const resp = { status: "success", message: "Quiz Deleted successfully", data: {} };
        res.status(200).send(resp);
    }
    catch (error) {
        next(error);
...
const publishQuiz = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const quiz = yield quiz_1.default.findById({ _id: quizId });
        if (!quiz) {
            const err = new projectError_1.default("Quiz not found");
            err.statusCode = 404;
            throw err;
        ...
        if (quiz.is_published) {
            const err = new projectError_1.default("Quiz Already Published");
            err.statusCode = 405;
            throw err;
        }
        quiz.is_published = true;
        yield quiz.save();
        const resp = { status: "success", message: "Quiz Published successfully", data: {} };
        res.status(200).send(resp);
    }
    catch (error) {
        next(error);
